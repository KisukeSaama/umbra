...
export const en = {
  ...
  "home.inProgress.hint": "Taken up, on their way to Kisuflix.",
  ...
  "storage.freeOf": "free of {total}",
  "storage.roomIntro": "Room for about",
  "storage.unit.movies": "films",
  "storage.unit.movies.one": "film",
  "storage.unit.episodes": "episodes",
  "storage.unit.episodes.one": "episode",
  "storage.room.both": "Room for about {movies} films or {episodes} episodes.",
  "storage.room.movies": "Room for about {movies} films.",
  "storage.room.episodes": "Room for about {episodes} episodes.",
  "storage.pace.days": "At the current pace, full in about {count} days.",
  "storage.pace.days.one": "At the current pace, full within a day or so.",
  "storage.pace.weeks": "At the current pace, full in about {count} weeks.",
  ...
  "admin.queue.selected.one": "{count} selected",
  "admin.queue.clearSelection": "Clear",
  "admin.queue.bulk.accept": "Accept {count} requests",
  "admin.queue.bulk.accept.one": "Accept {count} request",
  ...
  "admin.queue.bulk.onlySome.one":
    "Only {count} of the {total} selected can take this move; the others are left as they are.",
  "admin.queue.bulk.keepNotes":
    "Left empty, each request keeps the word it already carries.",
  "admin.queue.bulk.done": "{count} requests moved.",
  "admin.queue.bulk.done.one": "{count} request moved.",
  "admin.queue.bulk.failed": "{count} could not be moved: {reason}",
  "admin.queue.bulk.failed.one": "{count} could not be moved: {reason}",
  ...
  "admin.announcements.likedBy": "{count} people liked it",
  "admin.announcements.likedBy.one": "{count} person liked it",
  ...
  "admin.accounts.noteLeft": "{count} characters left",
  "admin.accounts.noteLeft.one": "{count} character left",
  ...
  "picker.resultHint.noneHere":
    "Nothing on Kisuflix fits this yet. These can be asked for.",
  "picker.resultHint.allHere": "All of these are already on Kisuflix.",
  ...
  "picker.era": "Which era?",
  "picker.era.classic": "Before 1980",
  "picker.era.classic.hint": "Titles first released before 1980.",
  "picker.era.modern": "1980 to 2009",
  "picker.era.modern.hint": "Titles first released between 1980 and 2009.",
  "picker.era.recent": "Since 2010",
  "picker.era.recent.hint": "Titles first released in 2010 or later.",
  "picker.era.any": "Any era",
  "picker.era.any.hint": "Old and new are both welcome.",
  "picker.origin": "Which original language?",
  "picker.origin.french": "French",
  "picker.origin.french.hint": "Titles made in French.",
  "picker.origin.world": "Not English",
  "picker.origin.world.hint": "Titles made in any language but English.",
  "picker.origin.any": "Any language",
  "picker.origin.any.hint": "Every original language is welcome.",
  ...
  "title.removedBefore":
    "It was on Kisuflix until {date}, most likely removed to make room. You can ask for it again.",
  "title.cancelRequest": "Cancel this request",
  "title.similar": "In the same vein",
  "title.score": "Rated {score} out of 10 on TMDB",
  "title.scoreMal": "Rated {score} out of 10 on MyAnimeList",
...
export const fr: Record<TranslationKey, string> = {
  ...
  "week.tomorrow": "Demain",
  "home.inProgress.hint": "Pris en charge, en route vers Kisuflix.",
  ...
  "storage.freeOf": "libres sur {total}",
  "storage.roomIntro": "De quoi accueillir environ",
  "storage.unit.movies": "films",
  "storage.unit.movies.one": "film",
  "storage.unit.episodes": "épisodes",
  "storage.unit.episodes.one": "épisode",
  "storage.room.both":
    "De quoi accueillir environ {movies} films ou {episodes} épisodes.",
  "storage.room.movies": "De quoi accueillir environ {movies} films.",
  "storage.room.episodes": "De quoi accueillir environ {episodes} épisodes.",
  "storage.pace.days": "Au rythme actuel, plein dans environ {count} jours.",
  "storage.pace.days.one": "Au rythme actuel, plein d'ici un jour environ.",
  "storage.pace.weeks":
    "Au rythme actuel, plein dans environ {count} semaines.",
  ...
  "admin.queue.selected.one": "{count} sélectionnée",
  "admin.queue.clearSelection": "Désélectionner",
  "admin.queue.bulk.accept": "Accepter {count} demandes",
  "admin.queue.bulk.accept.one": "Accepter {count} demande",
  ...
  "admin.queue.bulk.onlySome.one":
    "Seule {count} des {total} sélectionnées est concernée ; les autres restent telles quelles.",
  "admin.queue.bulk.keepNotes":
    "Laissé vide, chaque demande garde le mot qu'elle porte déjà.",
  "admin.queue.bulk.done": "{count} demandes traitées.",
  "admin.queue.bulk.done.one": "{count} demande traitée.",
  "admin.queue.bulk.failed": "{count} n'ont pas pu être traitées : {reason}",
  "admin.queue.bulk.failed.one": "{count} n'a pas pu être traitée : {reason}",
  ...
  "admin.announcements.likedBy": "{count} personnes ont aimé",
  "admin.announcements.likedBy.one": "{count} personne a aimé",
  ...
  "admin.accounts.noteLeft": "{count} caractères restants",
  "admin.accounts.noteLeft.one": "{count} caractère restant",
  ...
  "picker.visualStyle": "Anime, dessin animé ou réel ?",
  ...
  "picker.visualStyle.cartoon": "Dessin animé",
  ...
  "picker.resultHint.noneHere":
    "Rien sur Kisuflix ne correspond encore. Ceux-ci peuvent être demandés.",
  "picker.resultHint.allHere": "Tout est déjà sur Kisuflix.",
  "picker.mood.thrill": "Thriller",
  ...
  "picker.era": "Quelle époque ?",
  "picker.era.classic": "Avant 1980",
  "picker.era.classic.hint": "Des titres sortis avant 1980.",
  "picker.era.modern": "1980 à 2009",
  "picker.era.modern.hint": "Des titres sortis entre 1980 et 2009.",
  "picker.era.recent": "Depuis 2010",
  "picker.era.recent.hint": "Des titres sortis en 2010 ou après.",
  "picker.era.any": "Peu importe",
  "picker.era.any.hint": "Anciens et récents sont les bienvenus.",
  "picker.origin": "Quelle langue d'origine ?",
  "picker.origin.french": "Français",
  "picker.origin.french.hint": "Des titres tournés en français.",
  "picker.origin.world": "Autre que l'anglais",
  "picker.origin.world.hint":
    "Des titres tournés dans toute autre langue que l'anglais.",
  "picker.origin.any": "Peu importe",
  "picker.origin.any.hint": "Toutes les langues d'origine sont les bienvenues.",
  ...
  "title.removedBefore":
    "Il était sur Kisuflix jusqu'au {date}, retiré sans doute pour faire de la place. Vous pouvez le redemander.",
  "title.cancelRequest": "Annuler la demande",
  "title.similar": "Dans la même veine",
  "title.score": "Noté {score} sur 10 sur TMDB",
  "title.scoreMal": "Noté {score} sur 10 sur MyAnimeList",
