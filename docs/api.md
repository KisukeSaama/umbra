...
| `DELETE /api/admin/series/{id}`        |                                                         | Stops tracking a series and drops its calendar and tasks. A 409 while a request for it is accepted or processing, since the next cycle would track it again                                                                                                                                                  |
